...
`cd /Users/petercharlton/Documents/GitHub/; git clone https://github.com/peterhcharlton/mimic_wfdb_tutorials`
...
`cd ../.; jupyter-book build mimic_wfdb_tutorials`
...
`cd mimic_wfdb_tutorials; ghp-import -n -p -f _build/html`
```
